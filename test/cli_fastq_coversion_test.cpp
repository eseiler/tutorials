...
{
    app_test_result const result = execute_app("tutorials");
...
{
    app_test_result const result = execute_app("tutorials", "-v");
...
{
    app_test_result const result = execute_app("tutorials", data("in.fastq"));
...
{
    app_test_result const result = execute_app("tutorials", data("in.fastq"), "-v");
...
{
    app_test_result const result = execute_app("tutorials", data("in.fastq"), "-o", "out.fasta");
...
{
    app_test_result const result = execute_app("tutorials", data("in.fastq"), "-o", "");
...
{
    app_test_result const result = execute_app("tutorials", data("in.fastq"), "-o", "does_not_exist/out.fasta");
